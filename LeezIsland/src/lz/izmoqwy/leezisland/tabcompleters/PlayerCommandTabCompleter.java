package lz.izmoqwy.leezisland.tabcompleters;

import com.google.common.collect.Lists;
import lz.izmoqwy.core.api.CompleteOptions;
import lz.izmoqwy.core.api.CoreTabCompleter;
...
public class PlayerCommandTabCompleter extends CoreTabCompleter {
	...
	private static List<String> ISLAND_DEFAULT = Arrays.asList("go", "info", "help", "personnalhome", "level", "team", "coops", "banlist", "expel", "teamchat", "send", "vault"),
	...
	public PlayerCommandTabCompleter() {
		super("island", new CompleteOptions().playerOnly());
	}
	...
	public List<String> get(CommandSender commandSender, String usedCommand, String[] args) {
		if (args.length == 1) {
			...
			switch(args[0].toLowerCase()) {
				...
				case "coop":
				case "ban":
					if (c(args[1],"invite", "coop", "ban") && !player.getIsland().hasRoleOrAbove(player, IslandRole.RECRUTER)) {
						return null;
					}
